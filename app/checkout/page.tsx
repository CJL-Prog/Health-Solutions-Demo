        ...
        return (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="mt-8 pt-6 border-t">
                <h3 className="text-lg font-semibold mb-4">Available Subscription Programs</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    { name: 'Weight Loss Stack', discount: '15%', products: 'Semaglutide + Consultation' },
                    { name: 'Recovery Protocol', discount: '12%', products: 'BPC-157 + TB-500' },
                    { name: 'Anti-Aging Bundle', discount: '18%', products: 'NAD+ + Epithalon + GHK-Cu' },
                    { name: 'Wellness Package', discount: '10%', products: 'Custom peptide selection' }
                  ].map((program, i) => (
                    <div key={i} className="border rounded-lg p-4 hover:shadow-md transition">
                      <h4 className="font-semibold mb-2">{program.name}</h4>
                      <p className="text-sm text-gray-600 mb-2">{program.products}</p>
                      <div className="flex justify-between items-center">
                        <span className="text-green-600 font-medium">Save {program.discount}</span>
        ...
        return (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="mt-8 pt-6 border-t">
                <h3 className="text-lg font-semibold mb-4">Available Consultation Types</h3>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { type: 'Weight Loss Consultation', duration: '30 min', price: '$149', description: 'Personalized weight management plan' },
                    { type: 'HRT Assessment', duration: '45 min', price: '$199', description: 'Hormone replacement therapy evaluation' },
                    { type: 'Peptide Protocol Design', duration: '60 min', price: '$249', description: 'Custom peptide therapy plan' },
                    { type: 'Lab Results Review', duration: '30 min', price: '$99', description: 'Comprehensive lab analysis' },
                    { type: 'Follow-up Check-in', duration: '20 min', price: '$79', description: 'Progress monitoring session' },
                    { type: 'Nutrition Counseling', duration: '45 min', price: '$129', description: 'Dietary optimization guidance' }
                  ].map((consult, i) => (
                    <div key={i} className="border rounded-lg p-4 hover:shadow-md transition">
                      <h4 className="font-semibold mb-2">{consult.type}</h4>
                      <p className="text-sm text-gray-600 mb-3">{consult.description}</p>
                      <div className="flex justify-between items-center mb-3">
                        <span className="text-sm text-gray-500">{consult.duration}</span>
                        <span className="font-bold text-blue-600">{consult.price}</span>
                      </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="mt-8 pt-6 border-t">
                ...
                <div className="space-y-4">
                  {[
                    { label: 'Order updates and shipping notifications', checked: true },
                    { label: 'Consultation reminders', checked: true },
                    { label: 'New product announcements', checked: false },
                    { label: 'Health tips and educational content', checked: true },
                    { label: 'Special offers and promotions', checked: false },
                    ...
                    <div key={i} className="flex items-center">
                      ...
                      />
                      <label htmlFor={`pref-${i}`} className="text-sm text-gray-700">{pref.label}</label>
                    </div>
                  ))}
                </div>
              </div>
